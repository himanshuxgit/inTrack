  ...
  const saveProfile = async (event: FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        image.append("cloud_name", "dn1zgumdh");
        image.append("upload_preset", "rmkb2vgm");

        // save to cloudinary
        const response = await fetch(
          "https://api.cloudinary.com/v1_1/dn1zgumdh/image/upload",
      ...
      console.log("hubyvygygviyugbu",data);

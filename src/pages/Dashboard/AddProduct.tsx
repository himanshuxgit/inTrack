...
const AddProduct = () => {
  ...
  const saveProduct = async (event: FormEvent) => {
    ...
    // console.log("formData tsx", formData, formData.values(), formData.entries(), "asdsdada", formData.get("name"), formData.get("sku"), formData.get("category"), formData.get("quantity"), formData.get("price"), formData.get("description"));
